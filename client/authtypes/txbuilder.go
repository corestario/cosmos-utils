...
func (bldr TxBuilder) SignWithPrivKey(privKey crypto.PrivKey, msg StdSignMsg) ([]byte, error) {
...
func MakeSignatureWithPrivateKey(privKey crypto.PrivKey, msg StdSignMsg) (sig StdSignature, err error) {
